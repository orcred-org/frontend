...
const fields: FieldDef[] = [
  ...
  { id: "years",    label: "Years in AI/ML",                   placeholder: "e.g. 6 years",                                 type: "text",     required: true },
  ...
  return (
    <motion.div key="success" className="flex flex-col items-start gap-8 py-4"
      ...
      <div style={{ fontSize: "13px", fontWeight: 400, lineHeight: 1.9, color: "var(--fg-muted)", maxWidth: "320px" }}>
        We review every application personally. If you&apos;re a fit, we&apos;ll reach out to schedule a calibration call.
      </div>
    </motion.div>
  );
}
    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: "var(--bg-page)" }}>
      ...
      <div className="relative z-10 flex-1 max-w-[1100px] mx-auto w-full px-8 sm:px-12 lg:px-16 py-16 sm:py-20 lg:py-24">
        ...
        <motion.div className="flex items-center gap-4 mb-14" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.9 }}>
          ...
          <div className="font-label-sm uppercase tracking-[0.42em] text-[9px]" style={{ color: "var(--orange-faint)" }}>Reviewers</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-4">
            ...
            >
              You&apos;ve been in enough rooms to know within 60 seconds. That instinct is exactly what Orcred is built on. Five founding reviewer spots remain.
            </motion.div>
            <motion.div className="mt-8 space-y-3" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1, delay: 0.35 }}>
              {["5+ years AI/ML industry experience", "Equity in Orcred", "Founding reviewer badge", "Direct say in the standard"].map((item, i) => (
